...
## JointJS 4.3.1 (`@joint/core`)

- Datei: `joint-4.3.1.min.js`
- Upstream: https://github.com/clientIO/joint
- Paket: https://www.npmjs.com/package/@joint/core/v/4.3.1
- Lizenz: MPL-2.0, siehe `joint-4.3.1.LICENSE.md`
- Browserdatei: 473.318 Byte (gzip 143.111 Byte), SHA-256 `e1d9479e9dda82aa61b6efca7f883f8a80801988867bed2643d45df4146c0592`
- Verwendet in: `prototypes/jointjs-schaltbild/index.html`, nicht im App-Katalog verlinkt.
- Zweck: isolierter Vergleich von Touch-Verschieben, Anschlussports und automatisch geführten Leitungen. Die bestehende Schaltbild-Werkstatt und ihr Solver bleiben unverändert.
